...
{
    /// <inheritdoc />
    [Migration("20260810120000_AddIdentityUserWorkspaces")]
    public partial class AddIdentityUserWorkspaces : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CatalogYear = table.Column<int>(type: "INTEGER", nullable: false),
                    StartingTerm = table.Column<string>(type: "TEXT", maxLength: 30, nullable: false),
                    PreferredCredits = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateIndex(name: "IX_StudentCourses_UserId", table: "StudentCourses", column: "UserId");
            ...
            migrationBuilder.CreateIndex(name: "IX_ChatMessages_ChatSessionId", table: "ChatMessages", column: "ChatSessionId");
            migrationBuilder.CreateIndex(name: "IX_ChatSessions_UserId", table: "ChatSessions", column: "UserId");
        ...
        {
            migrationBuilder.DropForeignKey(name: "FK_StudentCourses_AspNetUsers_UserId", table: "StudentCourses");
            ...
            migrationBuilder.DropIndex(name: "IX_StudentCourses_UserId", table: "StudentCourses");
            migrationBuilder.DropColumn(name: "UserId", table: "StudentCourses");
            migrationBuilder.AlterColumn<int>(
                name: "StudentId",
                table: "StudentCourses",
                type: "INTEGER",
